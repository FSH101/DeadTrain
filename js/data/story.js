    ...
    faceless: {
      ...
      nodes: {
        ...
        choose: {
          ...
          scene: {
            image: 'assets/faceless-compartment.svg',
            alt: 'Скамья в вагоне с тремя тёмными пассажирами и дверью тамбура справа.',
            label: 'Пассажиры в сумрачном вагоне.',
            caption: 'Силуэты молчат. Выбери, к кому приблизиться.',
            hideActions: true,
            hotspots: [
              {
                optionIndex: 0,
                className: 'scene-hotspot--passenger',
                label: 'Женщина с детской коляской',
                text: 'Женщина',
                top: '56%',
                left: '32%',
                width: '14%',
              ...
              },
              {
                optionIndex: 1,
                className: 'scene-hotspot--passenger',
                label: 'Контролёр в форменной фуражке',
                text: 'Контролёр',
                top: '54%',
                left: '49%',
                width: '14%',
              ...
              },
              {
                optionIndex: 2,
                className: 'scene-hotspot--passenger',
                label: 'Парень у двери с дрожащими руками',
                text: 'Парень',
                top: '54%',
                left: '66%',
                width: '14%',
        ...
        reselect: {
          ...
          scene: {
            image: 'assets/faceless-compartment.svg',
            alt: 'Тот же вагон с пассажирами и дверью.',
            label: 'Раздумья в вагоне.',
            caption: 'Остаться разговаривать или уйти через двери?',
            hideActions: true,
            hotspots: [
              {
                optionIndex: 0,
                className: 'scene-hotspot--passenger',
                label: 'Поговорить с кем-то ещё',
                text: 'Поговорить ещё',
                top: '56%',
                left: '49%',
                width: '46%',
              ...
              {
                optionIndex: 2,
                className: 'scene-hotspot--exit',
                label: 'Назад, в служебный отсек',
                text: 'Назад',
                top: '78%',
                left: '18%',
                width: '20%',
